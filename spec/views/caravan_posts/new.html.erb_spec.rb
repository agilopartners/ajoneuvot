...
describe "caravan_posts/new.html.erb" do
  before(:each) do
    assign(:caravan_post, stub_model(CaravanPost,
      :caravan_type_id => 1,
  ...
  it "renders new caravan_post form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => caravan_posts_path, :method => "post" do
