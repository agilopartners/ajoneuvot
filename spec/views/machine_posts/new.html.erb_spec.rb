...
describe "machine_posts/new.html.erb" do
  before(:each) do
    assign(:machine_post, stub_model(MachinePost,
      :machine_type_id => 1,
  ...
  it "renders new machine_post form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => machine_posts_path, :method => "post" do
