...
describe "ilmoitus/new.html.erb" do
  before(:each) do
    assign(:ilmoitu, stub_model(Ilmoitu,
      :type => "MyString",
      :make => "MyString",
      :model => "MyString",
      :subtype => "MyString",
  ...
  it "renders new ilmoitu form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => ilmoitus_path, :method => "post" do
