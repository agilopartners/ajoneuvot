...
describe "domicile_type_sections/new.html.erb" do
  before(:each) do
    assign(:domicile_type_section, stub_model(DomicileTypeSection,
      :name => "MyString",
      :boats_position_town_type_id => 1
    ).as_new_record)
  end

  it "renders new domicile_type_section form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => domicile_type_sections_path, :method => "post" do
