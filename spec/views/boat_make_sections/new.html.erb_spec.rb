...
describe "boat_make_sections/new.html.erb" do
  before(:each) do
    assign(:boat_make_section, stub_model(BoatMakeSection,
      :name => "MyString",
      :boat_sub_type_section_id => 1
    ).as_new_record)
  end

  it "renders new boat_make_section form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => boat_make_sections_path, :method => "post" do
