...
describe "car_posts/new.html.erb" do
  before(:each) do
    assign(:car_post, stub_model(CarPost,
      :car_type_id => 1,
  ...
  it "renders new car_post form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => car_posts_path, :method => "post" do
